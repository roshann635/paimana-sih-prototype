...
import { mockDashboardSummary, mockModelHealth, mockDataQuality } from '../../data/mock/mockData';
...
async function fetchJson(endpoint, options = {}) {
  try {
    ...
    console.warn(`[API] Fetch failed for ${endpoint}, using fallback if available:`, err.message);
    throw err;
  }
}
