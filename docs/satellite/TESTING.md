# 🧪 PARAKH Satellite Automated Testing & Invariant Verification
...
PARAKH includes 30 automated tests in [test_satellite.py](file:///d:/PARAKH/tests/test_satellite.py) and [test_api.py](file:///d:/PARAKH/tests/test_api.py) verifying all core scientific invariants, edge cases, failure states, and user journeys.
...
| **Test 8** | `test_invariant_8_synthetic_provenance` | Demo provider fixture | `is_synthetic: true`, `source: PARAKH DEMO FIXTURE` | **PASS** |
...
| **Test 28** | `test_test_28_provenance_and_disclaimer_integrity` | Provenance & disclaimer | Contains `PARAKH DEMO GEOMETRY` & disclaimer | **PASS** |
